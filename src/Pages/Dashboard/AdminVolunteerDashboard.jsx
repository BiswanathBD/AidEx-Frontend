...
const AdminVolunteerDashboard = () => {
  ...
  return (
    <motion.div
      ...
      className="p-4 sm:p-6 lg:p-8 mt-4 bg-white rounded-xl"
    >
      ...
      {loading ? (
        ...
        <div className="grid xl:grid-cols-3 gap-5 sm:gap-8 mt-6">
          <motion.div
            ...
            className="p-4 sm:p-6 lg:p-10 rounded-lg bg-linear-to-br from-blue-50/50 to-blue-100 flex items-center gap-4 sm:gap-8"
          >
          ...
          <motion.div
            ...
            className="p-4 sm:p-6 lg:p-10 rounded-lg bg-linear-to-br from-green-50/50 to-green-100 flex items-center gap-4 sm:gap-8"
          >
            <div className="text-gray-500 shrink-0">
          ...
          <motion.div
            ...
            className="p-4 sm:p-6 lg:p-10 rounded-lg bg-linear-to-br from-red-50/50 to-red-100 flex items-center gap-4 sm:gap-8"
          >
            <div className="text-gray-500 shrink-0">
